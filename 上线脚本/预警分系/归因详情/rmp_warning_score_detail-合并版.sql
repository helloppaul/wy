...
-- /* 2022-11-13 新增 ori_idx_name和dim_submodel_contribution_ratio(各维度异常指标占比) 用于归因详报第四段和归因简报wy开发 */
-- /* 2022-11-16 新增 因子评价字段 取值由综合特征贡献度表 改为 高中低频和并的特征贡献度表 */
...
--     )C group by batch_dt,corp_id,corp_nm,score_dt,dimension,dim_submodel_contribution_ratio,dim_warn_level  --去重
-- ),
-- 评分卡 --
warn_score_card as 
(
