...
(
	select 2 property_cd,'城投' as property,'-5' as warn_lv,'3%' as percent_desc,'风险已暴露' as warn_lv_desc
	union all
	select 2 property_cd,'城投' as property,'-4' as warn_lv,'3%-15%' as percent_desc,'红色预警等级' as warn_lv_desc
	union all
	select 2 property_cd,'城投' as property,'-3' as warn_lv,'15%-26%' as percent_desc,'橙色预警等级' as warn_lv_desc
	union all
	select 2 property_cd,'城投' as property,'-2' as warn_lv,'26%-42%' as percent_desc,'黄色预警等级' as warn_lv_desc
	union all
	select 2 property_cd,'城投' as property,'-1' as warn_lv,'42%-100%' as percent_desc,'绿色预警等级' as warn_lv_desc 
	
	union all

	select 1 property_cd,'产业' as property,'-5' as warn_lv,'3%' as percent_desc,'风险已暴露' as warn_lv_desc
	union all
	select 1 property_cd,'产业' as property,'-4' as warn_lv,'3%-12%' as percent_desc,'红色预警等级' as warn_lv_desc
	union all
	select 1 property_cd,'产业' as property,'-3' as warn_lv,'12%-20%' as percent_desc,'橙色预警等级' as warn_lv_desc
	union all
	select 1 property_cd,'产业' as property,'-2' as warn_lv,'20%-36%' as percent_desc,'黄色预警等级' as warn_lv_desc
	union all
	select 1 property_cd,'产业' as property,'-1' as warn_lv,'36%-100%' as percent_desc,'绿色预警等级' as warn_lv_desc 

	union all

	select 0 property_cd,'产业' as property,'-5' as warn_lv,'3%' as percent_desc,'风险已暴露' as warn_lv_desc
	union all
	select 0 property_cd,'产业' as property,'-4' as warn_lv,'3%-12%' as percent_desc,'红色预警等级' as warn_lv_desc
	union all
	select 0 property_cd,'产业' as property,'-3' as warn_lv,'12%-20%' as percent_desc,'橙色预警等级' as warn_lv_desc
	union all
	select 0 property_cd,'产业' as property,'-2' as warn_lv,'20%-36%' as percent_desc,'黄色预警等级' as warn_lv_desc
	union all
	select 0 property_cd,'产业' as property,'-1' as warn_lv,'36%-100%' as percent_desc,'绿色预警等级' as warn_lv_desc 
)
