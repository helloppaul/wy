...
--Part1 副本 --
drop table if exists pth_rmp.tr_ods_rmp_fi_x_news_tcrnwitcode_xtskr;
create table pth_rmp.tr_ods_rmp_fi_x_news_tcrnwitcode_xtskr stored as parquet
as 
	select * from hds.tr_ods_rmp_fi_x_news_tcrnwitcode
;

drop table if exists pth_rmp.corp_chg_xtskr;
create table pth_rmp.corp_chg_xtskr stored as parquet 
as 
...
(
	...
	from pth_rmp.tr_ods_rmp_fi_x_news_tcrnwitcode_xtskr o
	where o.flag<>''
),
corp_chg as 
(
	select *
	from pth_rmp.corp_chg_xtskr
),
cm_property as
(	select 
		corp_id,
