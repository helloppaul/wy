-- RMP_WARNING_SCORE_REPORT 第一段 impala执行 --
...
drop table if exists pth_rmp.rmp_warning_score_report1_init_impala;  
create table pth_rmp.rmp_warning_score_report1_init_impala as    --@pth_rmp.rmp_warning_score_report1
--—————————————————————————————————————————————————————— 基本信息 ————————————————————————————————————————————————————————————————————————————————--
with
