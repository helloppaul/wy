...
(
    ...
    left join [SHUFFLE] warn_feature_value_two_days b   --昨
...
--         on a.score_dt=b.score_dt and a.zjh_cal=b.zjh_cal and a.idx_name=b.idx_name  --获取 与当前行的企业 同时间点 同行业 同指标的指标中位数
