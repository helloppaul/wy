-- 舆情司法诚信整合 (同步方式：一天多批次覆盖)--
--入参：${ETL_DATE}(20220818 int)  -> to_date(notice_dt)，给NULL初始化全部日期数据

-- set mem_limit=16600000000;
-- drop table if exists app_ehzh.rmp_opinion_risk_info_;
create table app_ehzh.rmp_opinion_risk_info_ as 
with 
corp_chg as 
(
...
insert into app_ehzh.rmp_opinion_risk_info_
with 
corp_chg as 
(
	select distinct a.corp_id,b.corp_name,b.credit_code,a.source_id,a.source_code
