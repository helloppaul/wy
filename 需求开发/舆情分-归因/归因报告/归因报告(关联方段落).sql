...
drop table if exists RMP_ATTRIBUTION_SUMM_REL_TEMP;
create table if not exists RMP_ATTRIBUTION_SUMM_REL_TEMP AS 
with 
...
(
	select 
		...
		--concat_ws('、',sort_array(collect_set(,'、')))) as imp_tag
